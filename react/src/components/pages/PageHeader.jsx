...
const PageHader = ({ title, pageName, url, openModal }) => {
    return (
        <div className="w-full mb-1">
                ...
                <nav className="flex mb-5" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        <li className="inline-flex items-center">
                            <Link to={'/dashboard'} className="inline-flex items-center text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <Link to={url} className="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">{pageName}</Link>
                            </div>
                        </li>

                    </ol>
                </nav>
                <h1 className="text-l font-semibold text-gray-800 sm:text-xl dark:text-white">{title}</h1>
            </div>
            <div className="sm:flex">
                ...
                <div className="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
